...
function verModificarUsuario(id){
    ...
    .then(function(response){
            var cadena='';
            var userComplete = response.data;
            if(userComplete){                
                cadena = `
                ...
                <form action="" method="post" id="modifyForm">
                    <input type="hidden" name="id" id="id" value="${userComplete.id}">
                    <label for="firstName" class="form-label">First Name</label>
                    <input type="text" class="form-control" name="firstName" id="firstName" required value="${userComplete.firstName}"> <br>
                    <label for="lastName"  class="form-label">Last Name</label>
                    <input type="text" class="form-control" name="lastName" id="lastName" required value="${userComplete.lastName}"> <br>
                    <label for="email" class="form-label">Email</label>
                    <input type="email" class="form-control" name="email" id="email" required value="${userComplete.email}"> <br>
                    <label for="password" class="form-label">Password</label>
                    <input type="password" class="form-control" id="password" name="password" required> <br>
                    <button type="button" class="btn btn-outline-warning" 
                        onclick="modificarUsuario('${userComplete.id}')">Modificar
                    </button>
                </form>`;
            }
